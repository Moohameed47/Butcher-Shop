		...
		hasClass: function () {
			...
			return (
				o(
					this,
					(e) =>
						a.filter((t) => e.classList.contains(t)).length > 0
				).length > 0
			);
		},
	...
	const re = [
				...
				0 !== s.length &&
					...
					e.clickable &&
						s.on("click", U(e.bulletClass), function (e) {
							e.preventDefault();
							let s =
								d(this).index() * t.params.slidesPerGroup;
				...
				if (!(a < m.slideWidth && i < m.slideHeight)) {
					...
					e.cancelable && e.preventDefault(),
						...
						(g.y =
							...
							(Date.now() - g.prevTime) /
							2),
						Math.abs(f.touchesCurrent.x - g.prevPositionX) <
							2 && (g.x = 0),
						Math.abs(f.touchesCurrent.y - g.prevPositionY) <
							2 && (g.y = 0),
						(g.prevPositionX = f.touchesCurrent.x),
						(g.prevPositionY = f.touchesCurrent.y),
						(g.prevTime = Date.now()),
					...
					setTranslate: function (e, s) {
						...
						function o(e) {
							...
							"slide" === t.params.controller.by &&
								...
								(n = -t.controller.spline.interpolate(
									-s
								))),
								(n &&
									"container" !==
		...
		function (e) {
			...
			function n() {
				...
				if (
					a &&
					d(a).hasClass(t.params.thumbs.slideThumbActiveClass)
				)
					return;
				if (null == s) return;
				let i;
		...
		function (e) {
			...
			r({ grid: { rows: 1, fill: "column" } }),
				(i.grid = {
					...
					updateSlide: (e, r, n, l) => {
						const { slidesPerGroup: o, spaceBetween: d } =
								i.params,
