		...
		<div class="container-fluid mx-2  Color-Nav">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto mb-2 mb-lg-0">
					<li class="nav-item ">
						<a class="nav-link p-2 active fs-5 Color-Nav" aria-current="page" href="#">Home</a>
					</li>
					<li class="nav-item mx-lg-5">
						<a class="nav-link px-2 fs-5 Color-Nav" href="product">Products</a>
					</li>
					<li class="nav-item">
				...
				<div class=" ps-3 pe-3 me-5 d-inline fs-5">
                    @if(auth()->user())
                        <div class="icon d-inline"><a href="/logout" class="fa-solid fa-user ">{{auth()->user()->name}} - Logout</a></div>
                    @else
                        <div class="icon d-inline"><a href="/login" class="fa-solid fa-user "></a></div>
                    @endif
					<div class="icon d-inline mx-3"><a href="/cart" class="fa-solid fa-cart-shopping"></a></div>
					<div class="icon d-inline"><a href="#" class="fa-solid fa-right-from-bracket"></a></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-lg-4 col-xl-3 mb-md-0 mb-4 w-20">
                            ...
                            <ul style="list-style-type: none" class="">
                                <li class="mb-2 I-H">
                                    <a class="text-decoration-none I-H" href="about.html">About Us</a>
                                </li>
                                <li class="mb-2 I-H">
                                    <a class="text-decoration-none I-H" href="product.html">Products</a>
                                </li>
                                <li class="mb-2 I-H">
